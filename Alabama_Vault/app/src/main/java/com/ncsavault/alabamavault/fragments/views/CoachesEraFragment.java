 ...
 * @author aqeeb.pathan
 */
public class CoachesEraFragment extends BaseFragment implements PullRefreshTask.UpdateTabDtoInfo, AbstractView {
    ...
    public ArrayList<VideoDTO> coachesVideoList = new ArrayList<VideoDTO>();
        ...
        public void onRefresh() {
            if (Utils.isInternetAvailable(mActivity.getApplicationContext())) {
                if (MainActivity.autoRefreshProgressBar.getVisibility() == View.VISIBLE) {
                    ...
                    PullRefreshTask pullRefreshTask = new PullRefreshTask(mActivity, GlobalConstants.COACH_API_URL, GlobalConstants.OKF_COACH, isBannerUpdated, stickyListHeadersListView, refreshLayout,
                            videoHeaderListAdapter, tabBannerDTO, coachesVideoList, progressBar, tvsearchRecordsNotAvailable,
                            bannerCacheableImageView, bannerLayout, mBannerProgressBar, false, CoachesEraFragment.this);
                    ...
                    if (videoMap != null) {
                        if (videoMap.get("VideoId") != null) {
                            if (VaultDatabaseHelper.getInstance(mActivity.getApplicationContext()).isVideoAvailableInDB(videoMap.get("VideoId").toString())) {
                                ...
                                mVideoDataTaskModel.registerView(CoachesEraFragment.this);
...
//        progressBar.getIndeterminateDrawable().setColorFilter(Color.parseColor("#CC0000"), android.graphics.PorterDuff.Mode.MULTIPLY);
        ...
        mAdView = (AdView) v.findViewById(R.id.adView_coches);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                ...
                if (videoHeaderListAdapter != null) {
                    videoHeaderListAdapter.isHeaderDisable = false;
                }
                return false;
            }
        });
        ...
        searchView.setOnQueryTextListener(new OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                // TODO Auto-generated method stub
                System.out.println("11111onQueryTextSubmit");
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (progressBar.isShown() && coachesVideoList.size() > 0) {
                    progressBar.setVisibility(View.GONE);
                }
...
//                        progressBar.setVisibility(View.GONE);
//                    }
//                } else if (coachesVideoList.size() == 0) {
////                    if (progressBar.isShown()) {
////                        progressBar.setVisibility(View.GONE);
////                        tvsearchRecordsNotAvailable.setVisibility(View.VISIBLE);
////                        tvsearchRecordsNotAvailable.setText(GlobalConstants.NO_RECORDS_FOUND);
